...
public class HaversineConstFunction extends ValueSource {
  ...
  private final IntFieldSource weight;
  ...
  public HaversineConstFunction(double latCenter, double lonCenter, IntFieldSource weightSource,VectorValueSource vs) {
  ...
  public FunctionValues getValues(Map context, LeafReaderContext readerContext) throws IOException {
    ...
    final FunctionValues weightVal=weight.getValues(context, readerContext);
    return new DoubleDocValues(this) {
      ...
      public double doubleVal(int doc) {
       ...
       // return (EARTH_MEAN_DIAMETER * Math.atan2(Math.sqrt(h), Math.sqrt(1 - h)))+weightVal.doubleVal(doc)/1000.0;
