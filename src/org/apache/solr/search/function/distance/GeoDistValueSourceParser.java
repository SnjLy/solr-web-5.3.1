...
public class GeoDistValueSourceParser extends ValueSourceParser {
  ...
  public ValueSource parse(FunctionQParser fp) throws SyntaxError {
    ...
    IntFieldSource vs=null;
    if (mv1 == null) {
      mv1 = parsePoint(fp);
      mv2 = parseSfield(fp);
      String rankFiled="rank_new";
      SchemaField sf = fp.getReq().getSchema().getField(rankFiled);
      vs=(IntFieldSource)sf.getType().getValueSource(sf, null);
    ...
    if (constants != null && other instanceof VectorValueSource) {
      return new HaversineConstFunction(constants[0], constants[1],vs, (VectorValueSource)other);
    }
